...
function getMessage(messageType, client) {
  ...
  } else if (!client.tokenResponse.smart_web_messaging_handle) {
    console.error('SMART client tokenResponse has no smart_web_messaging_handle!');
  }
  return {
...
export function getHandshakeResponse(client) {
