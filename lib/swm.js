...
export function enablePostMessage(targetOrigin, callback) {
  console.log('postMessage ENABLED');  // XXX
  _internal.targetOrigin = targetOrigin;
  _internal.callback = callback;
  window.addEventListener('message', postMessageHandler, false);
}

export function disablePostMessage() {
  console.log('postMessage DISABLED');  // XXX
  window.removeEventListener('message', postMessageHandler, false);
  _internal.targetOrigin = undefined;
  _internal.callback = undefined;
}
