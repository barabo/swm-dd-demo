...
function getPostMessageHandler(targetOrigin, callback) {
  return function (e) {
...
export function enablePostMessage(targetOrigin, callback) {
  window.addEventListener(
    'message',
    getPostMessageHandler(targetOrigin, callback),
    false,
  );
}

export function disablePostMessage(targetOrigin, callback) {
