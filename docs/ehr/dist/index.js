...
function getHandshakeResponse(responseToMessageId) {
...
function getUiDoneResponse(responseToMessageId, status, statusDetailText) {
  return getUiResponse(responseToMessageId, status, statusDetailText);
}
function getUiLaunchActivityResponse(responseToMessageId, status, statusDetailText) {
  return getUiResponse(responseToMessageId, status, statusDetailText);
}
...
function getScratchpadCreateResponse(responseToMessageId, status, location, outcome) {
  return getScratchpadResponse(responseToMessageId, status, location, outcome);
}
function getScratchpadUpdateResponse(responseToMessageId, status, location, outcome) {
  return getScratchpadResponse(responseToMessageId, status, location, outcome);
}
function getScratchpadDeleteResponse(responseToMessageId, status, outcome) {
...
function Ehr() {
  ...
  function sendResponse2() {
    try {
      ...
      sendResponse(window2, r, appOrigin);
    } catch (e) {
